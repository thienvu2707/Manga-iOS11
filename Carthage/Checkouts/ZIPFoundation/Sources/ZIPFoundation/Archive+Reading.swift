...
public extension Archive {
    ...
    public func extract(_ entry: Entry, bufferSize: UInt32 = defaultReadChunkSize, consumer: Consumer) throws -> CRC32 {
        ...
        case .file:
            ...
            case .none: checksum = try self.readUncompressed(entry, bufferSize: bufferSize, with: consumer)
            case .deflate: checksum = try self.readCompressed(entry, bufferSize: bufferSize, with: consumer)
            }
    ...
    fileprivate func readUncompressed(_ entry: Entry, bufferSize: UInt32, with consumer: Consumer) throws -> CRC32 {
    ...
    fileprivate func readCompressed(_ entry: Entry, bufferSize: UInt32, with consumer: Consumer) throws -> CRC32 {
